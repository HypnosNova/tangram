/*
 Leaflet 0.8-dev (d93e828), a JS library for interactive maps. http://leafletjs.com
...
! function(t, e, i) {
	...
	s.addEventListener = s.on, s.removeEventListener = s.clearAllEventListeners = s.off, s.addOneTimeEventListener = s.once, s.fireEvent = s.fire, s.hasEventListeners = s.listens, o.Mixin = {
		...
		function() {
			var i = navigator.userAgent.toLowerCase(),
				...
				_ = s && "transition" in n.style,
				m = "WebKitCSSMatrix" in t && "m11" in new t.WebKitCSSMatrix && !h,
				p = "MozPerspective" in n.style,
				f = "OTransition" in n.style,
				g = "devicePixelRatio" in t && t.devicePixelRatio > 1;
			if (!g && "matchMedia" in t) {
				var v = t.matchMedia("(min-resolution:144dpi)");
				g = v && v.matches
			}
			var y = !t.L_NO_TOUCH && !a && (d || "ontouchstart" in t || t.DocumentTouch && e instanceof t.DocumentTouch);
			o.Browser = {
				ie: s,
		...
		function() {
			...
			getBoundsZoom: function(t, e, i) {
				...
				var n, s = this.getMinZoom() - (e ? 1 : 0),
					...
					u = !0;
				i = o.point(i || [0, 0]);
				do s++, n = this.project(l, s).subtract(this.project(h, s)).add(i), u = e ? n.x < a.x || n.y < a.y : a.contains(n); while (u && r >= s);
			...
			_pruneTiles: function() {
				if (this._map) {
					...
					for (i in this._tiles) this._retain[i] || setTimeout(o.bind(this._deferRemove, this, i), 250)
				}
			},
			...
			_retainParent: function(t, e, i, n) {
				var o = Math.floor(t / 2),
					...
					r = i - 1,
					a = o + ":" + s + ":" + r;
				return this._loaded[a] ? (this._retain[a] = !0, !0) : r > n ? this._retainParent(o, s, r, n) : !1
			},
			_retainChildren: function(t, e, i, n) {
				for (var o = 2 * t; 2 * t + 2 > o; o++)
					for (var s = 2 * e; 2 * e + 2 > s; s++) {
						var r = o + ":" + s + ":" + (i + 1);
						this._loaded[r] ? this._retain[r] = !0 : n > i + 1 && this._retainChildren(o, s, i + 1, n)
					}
			},
			_reset: function(t) {
				var e = this._map,
			...
			_addTiles: function(t) {
				...
				if (0 !== l) {
					...
					for (n = 0; l > n; n++) this._addTile(r[n], u);
			...
			getTileUrl: function(t) {
				return o.Util.template(this._url, o.extend({
					...
					x: t.x,
					y: this.options.tms ? this._tileNumBounds.max.y - t.y : t.y,
			...
			initialize: function(t, e) {
				...
				for (var n in e) this.options.hasOwnProperty(n) || "crs" === n || "uppercase" === n || (i[n] = e[n]);
				e = o.setOptions(this, e), i.width = i.height = e.tileSize * (e.detectRetina && o.Browser.retina ? 2 : 1), this.wmsParams = i
			},
			onAdd: function(t) {
				this._crs = this.options.crs || t.options.crs, this._uppercase = this.options.uppercase || !1, this._wmsVersion = parseFloat(this.wmsParams.version);
			...
			getTileUrl: function(t) {
				...
				return r + o.Util.getParamString(this.wmsParams, r, this._uppercase) + (this._uppercase ? "&BBOX=" : "&bbox=") + s
			},
			...
			_initInteraction: function() {
				this.options.interactive && (o.DomUtil.addClass(this._icon, "leaflet-interactive"), o.DomEvent.on(this._icon, "click dblclick mousedown mouseup mouseover mousemove mouseout contextmenu keypress", this._fireMouseEvent, this), o.Handler.MarkerDrag && (this.dragging && this.dragging.disable(), this.dragging = new o.Handler.MarkerDrag(this), this.options.draggable && this.dragging.enable()))
			},
			...
			_convertLatLngs: function(t) {
				for (var e = [], i = this._flat(t), n = 0, s = t.length; s > n; n++) i ? (e[n] = o.latLng(t[n]), this._bounds.extend(e[n])) : e[n] = this._convertLatLngs(t[n]);
				return e
			},
			_flat: function(t) {
			...
			_clipPoints: function() {
				...
				for (t = 0, i = 0, n = this._rings.length; n > t; t++)
					for (a = this._rings[t], e = 0, s = a.length; s - 1 > e; e++) r = o.LineUtil.clipSegment(a[e], a[e + 1], l, e), r && (h[i] = h[i] || [], h[i].push(r[0]), (r[1] !== a[e + 1] || e === s - 2) && (h[i].push(r[1]), i++))
			},
			...
			var i, n, s, r, a, h, l, u, c, d = [1, 4, 2, 8],
				_ = o.LineUtil;
			for (n = 0, l = t.length; l > n; n++) t[n]._code = _._getBitCode(t[n], e);
			for (r = 0; 4 > r; r++) {
				for (u = d[r], i = [], n = 0, l = t.length, s = l - 1; l > n; s = n++) a = t[n], h = t[s], a._code & u ? h._code & u || (c = _._getEdgeIntersection(h, a, u, e), c._code = _._getBitCode(c, e), i.push(c)) : (h._code & u && (c = _._getEdgeIntersection(h, a, u, e), c._code = _._getBitCode(c, e), i.push(c)), i.push(a));
				t = i
			}
			return t
			...
			getCenter: function() {
				...
				for (r = a = h = 0, t = 0, i = l.length, e = i - 1; i > t; e = t++) n = l[t], o = l[e], s = n.y * o.x - o.y * n.x, a += (n.x + o.x) * s, h += (n.y + o.y) * s, r += 3 * s;
			...
			_clipPoints: function() {
				...
				for (var n, s = 0, r = this._rings.length; r > s; s++) n = o.PolyUtil.clipPolygon(this._rings[s], t), n.length && this._parts.push(n)
			},
			_updatePath: function() {
			...
			_update: function() {
				if (!this._map._animatingZoom || !this._bounds) {
					...
					var t = this._bounds,
						...
						i = this._container,
						n = this.getPane();
					o.Browser.mobileWebkit && n.removeChild(i), o.DomUtil.setPosition(i, t.min), this._svgSize && this._svgSize.equals(e) || (this._svgSize = e, i.setAttribute("width", e.x), i.setAttribute("height", e.y)), o.DomUtil.setPosition(i, t.min), i.setAttribute("viewBox", [t.min.x, t.min.y, e.x, e.y].join(" ")), o.Browser.mobileWebkit && n.appendChild(i)
				}
			},
	...
	o.Marker.include(r), o.Circle.include(r), o.CircleMarker.include(r), o.Polyline.prototype.toGeoJSON = function() {
		...
		return t && 1 === this._latlngs.length && (e = !0, i = [i]), t || (i = [i]), o.GeoJSON.getFeature(this, {
	...
	o.DomEvent = {
		...
		_on: function(e, i, n, s) {
			...
			return o.Browser.pointer && 0 === i.indexOf("touch") ? this.addPointerListener(e, i, h, r) : o.Browser.touch && "dblclick" === i && this.addDoubleTapListener ? this.addDoubleTapListener(e, h, r) : "addEventListener" in e ? "mousewheel" === i ? (e.addEventListener("DOMMouseScroll", h, !1), e.addEventListener(i, h, !1)) : "mouseenter" === i || "mouseleave" === i ? (h = function(i) {
				return i = i || t.event, o.DomEvent._checkMouse(e, i) ? l(i) : void 0
		...
		_onDragEnd: function(t) {
			...
			if (e.fire("dragend", t), s) e.fire("moveend");
				...
				var r = this._lastPos.subtract(this._positions[0]),
					...
					d = l.multiplyBy(c / u),
					_ = c / (i.inertiaDeceleration * h),
					m = d.multiplyBy(-_ / 2).round();
				m.x && m.y ? (m = e._limitOffset(m, e.options.maxBounds), o.Util.requestAnimFrame(function() {
					e.panBy(m, {
						duration: _,
						easeLinearity: h,
						noMoveStart: !0,
		...
		addDoubleTapListener: function(t, i, n) {
			...
			return t.addEventListener(_, s, !1), p.addEventListener(m, r, !1), o.Browser.pointer && p.addEventListener(o.DomEvent.POINTER_CANCEL, r, !1), this
		},
		...
		_onTouchStart: function(t) {
			...
			if (t.touches && 2 === t.touches.length && !i._animatingZoom && !this._zooming) {
				...
				this._startCenter = n.add(s)._divideBy(2), this._startDist = n.distanceTo(s), this._moved = !1, this._zooming = !0, this._centerOffset = r.subtract(this._startCenter), i.stop(), o.DomEvent.on(e, "touchmove", this._onTouchMove, this).on(e, "touchend", this._onTouchEnd, this), o.DomEvent.preventDefault(t)
			}
		},
		...
		_updateOnMove: function() {
			var t = this._map;
			this._center = "center" === t.options.touchZoom ? t.getCenter() : t.layerPointToLatLng(this._getTargetCenter()), this._zoom = t.getScaleZoom(this._scale), t._animateZoom(this._center, this._zoom)
		},
		...
		_onInputClick: function() {
			...
			for (var o = 0, s = n.length; s > o; o++) t = n[o], e = this._layers[t.layerId].layer, i = this._map.hasLayer(e), t.checked && !i ? this._map.addLayer(e) : !t.checked && i && this._map.removeLayer(e);
	...
	h && o.Map.addInitHook(function() {
		...
		_animateZoom: function(t, e, i) {
			i && (this._animatingZoom = !0, this._animateToCenter = t, this._animateToZoom = e, o.Draggable && (o.Draggable._disabled = !0), o.DomUtil.addClass(this._mapPane, "leaflet-zoom-anim")), this.fire("zoomanim", {
				center: t,
				zoom: e,
